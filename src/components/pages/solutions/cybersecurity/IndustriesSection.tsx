        ...
        >
          ...
          >
            <IndustryCard
              ...
              subtitle="Oil, gas, power, and renewables trading infrastructure"
              widthClass="md:w-[60%]"
            />
            <IndustryCard
              image={imgIndustry1}
              title="Commodity Trading"
              subtitle="Agricultural and metals trading operations"
              widthClass="md:w-[40%]"
            />
          </div>
          <div
          ...
          >
            <IndustryCard
              ...
              subtitle="Generation, transmission, and distribution operations"
              widthClass="md:w-[40%]"
            />
            <IndustryCard
              image={imgIndustry3}
              title="Financial Services"
              subtitle="Trading infrastructure and risk management modernization"
              widthClass="md:w-[60%]"
            />
          </div>
          <div
          ...
          >
            <IndustryCard
              ...
              subtitle="Integrated trading across multiple commodities"
            />
          </div>
        </div>
      </div>
