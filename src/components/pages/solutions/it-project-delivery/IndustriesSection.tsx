        ...
        >
          ...
          >
            <IndustryCard
              ...
              subtitle="Generation, transmission, distribution, and retail operations"
              widthClass="md:w-[60%]"
            />
            <IndustryCard
              image={imgIndustry1}
              title="Oil & Gas"
              subtitle="Upstream, midstream, and downstream digital transformation"
              widthClass="md:w-[40%]"
            />
          </div>
          <div
          ...
          >
            <IndustryCard
              image={imgIndustry4}
              title="Multi-National Operations"
              subtitle="Regional integration and standardization projects"
            />
          </div>
        </div>
      </div>
