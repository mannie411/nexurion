...
import { imgDPD } from "@/assets/images";
        ...
        >
          <div className="basis-0 content-stretch flex flex-col grow items-start  relative shrink-0 w-full">
            <AccordionItem
              ...
              content="We map your current state, define target outcomes, and create a realistic transformation roadmap. Stakeholder interviews ensure we understand both technical and business requirements."
              isFirst={true}
            />
            <AccordionItem
              number="02."
